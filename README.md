@@ - WARNING: This sample has been DEPRECATED! This sample is based on old version of APS (Forge) API, especially BIM360 Issue API version 1. Some demos of this sample has ben migrated with new APIs.@@
